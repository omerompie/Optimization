...
# --- PATH SETUP ---
# Allows importing from parent directories if needed
...
def animate_optimization():
    # 1. LOAD DATA (Now reading from current folder)
    node_coords = {}
    x_coords, y_coords = [], []

    # Try reading the output files generated by main_dijkstra.py
    # Since this script is in the same folder, we don't need fancy paths
    try:
        ...
        print("Make sure you ran 'main_dijkstra.py' first!")
        return
    ...
    try:
        ...
        print("Error: 'search_history.txt' not found.")
        return

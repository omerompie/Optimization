...
from OLD.solver import solve_dynamic_dijkstra
...
def main():
    ...
    for start_hour in HOURS_TO_TEST:
        print(f"\nProcessing Time: t = {start_hour} hours.")
        ...
        if path:
            ...
            print(f"Cost: €{cost:.0f} | Time: {final_flight_time_h:.2f}h | States: {states_visited}")
